                                      ...
                                      >
                                        <img
                                          style="
                                            ...
                                            object-fit: cover;
                                          "
                                          src="https://i.ibb.co/xSL8bN9/logo.png"
                                        />
                                      </div>
                                    </td>
                                  </tr>
                                      ...
                                      <div align="center" class="alignment">
                                        ...
                                        <a href=${
                                          process.env.NODE_ENV === "development"
                                            ? `http://localhost:3000/signup/auth/validate?token=${token?.id}`
                                            : `https://bluetags.vercel.app/signup/auth/validate?token=${token?.id}`
                                        }>
                                          <div
                                            style="
                                              text-decoration: none;
                                ...
                                >
                                  <tr>
                                    ...
                                    >
                                      ...
                                      >
                                        <a
                                          href="https://bluetags.vercel.app/"
                                          target="_blank"
                                        >
                                          <img
                                            style="
